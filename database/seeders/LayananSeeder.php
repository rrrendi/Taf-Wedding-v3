...
class LayananSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = [
            ...
            ['nama' => 'Catering',         'icon' => '🍽️', 'kategori' => 'paket_wedding', 'satuan' => 'per_orang', 'harga' => 60000,    'deskripsi' => 'Menu pilihan berkualitas untuk seluruh tamu undangan. Harga per orang, otomatis dikalikan Estimasi Jumlah Tamu yang Anda isi.'],
