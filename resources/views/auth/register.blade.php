        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="field">
                ...
                <div style="position: relative;">
                    ...
                    <button type="button" tabindex="-1" onclick="let input = this.parentElement.querySelector('input'); let iconShow = this.querySelector('.ico-show'); let iconHide = this.querySelector('.ico-hide'); if(input.type === 'password') { input.type = 'text'; iconShow.style.display = 'none'; iconHide.style.display = 'block'; } else { input.type = 'password'; iconShow.style.display = 'block'; iconHide.style.display = 'none'; }" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: transparent; border: none; padding: 0; color: #888; cursor: pointer; display: flex; align-items: center; justify-content: center;">
